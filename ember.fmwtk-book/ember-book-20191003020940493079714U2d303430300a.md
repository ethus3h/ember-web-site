...
word processing app the more recent versions of which have had some
capabilities removed), and the incalculable loss of shared cultural
heritage through inconsistent or nonexistent archival practices (and in
many cases active hostility towards historical preservation, especially
in the interest of short-term personal economic gain) (for instance, the
loss of many historic films and television series to neglect or
...
Kahle](assets/6f22a47ab99f801cbe096224ff5a1649ada5683882426e5e6b4e233e80e0e201f561569d37a1dd2932e41d1531a5f4405b926fdbd3ef35acaaa7384e7904f911.jpg)](http://futuramerlin.com/102-000.jpg)
...
Diffie and Martin
Hellman](assets/24432f38581aa0d897d1edf6ca1f21343fb7b63bd710af512b122776e322b36114a21b6acba6ca79f67c2f39638e6997c3e4c06e8611a7eadd9349bc64bde32d.jpg)](http://futuramerlin.com/102-001.jpg)
...
format is implemented. See [\[http://futuramerlin.com/stagel.htm\]: its
documentation page](http://futuramerlin.com/stagel.htm) for more
information.
...
Storyboard [\[http://futuramerlin.com/image-001.png\]: ![I'm working on
making a new computer game. I made a great look for a Web site for the
game in a word processor. But now, the word processor won't let me put
my new game into the
file!](assets/a0961050a9ffa0896e557c8e13785a715ca39f28ea7387740dbd20012694d0b04df111eb2b7fe8cf192103e094b9c60083ba6aa6133bc48af0d49bdc61046002.png)](http://futuramerlin.com/image-001.png)
...
data.](assets/6fe2efe0e23b5cbd44e111d81299840a0d0bde0b9107a2ea38df139471ecb85671f3bfb7ef01e43f53aaa2a2029d708990be3672e03a2c77259066a9de76c4fd.png)](http://futuramerlin.com/image-002.png)
[\[http://futuramerlin.com/image-003.png\]: ![Great, now I can have the
game in my document, and post it to the Web like I originally wanted!
Problem
solved!](assets/878188bb05759181e98e289cb0ddef54c850463dc41f4ce1f8a4fd1b213d145d58e59f71272f5e309527c68947c3fa70f78df96946f91e32088932f7f7ce8455.png)](http://futuramerlin.com/image-003.png)
...
implementation runner](http://futuramerlin.com/tool-implrunner.htm), and
[\[http://futuramerlin.com/tool-edit.htm\]: simple document edit
...
tool](assets/6332bcdd1d3a4a8bfb8fdb423d235033dcf94f52450f9d0f2fb472cfc72a4ab0fbdc113385401ed4abc5b789a9f85d36e61a449f28d0693cc23c0c0dd523bd23.png)
...
mockup](assets/668143aca8ae7d28023de7ee7798266a170352357a3f86123aa861524de400ce1e5d856386dc7eaeacd7997e4f4fd2fe24b7f78ae1dc3cfeb118960c2b49546e.png)
...
runner](assets/310dbb98be48e941b3c4aeb334501f84d911ed0bca5efdeb1e288d8740d43bc76ec2ffaf7d0648abdf5cff25b1d66939745a464e13e841f76c0dcefbb0e70fa3.png)
...
-   Routines can be composed in argument lists, but unless you close the
    parameter lists explicitly using `}`, only one inner routine can be
    used per argument list; the inner routine must be the last argument.
    Using `}` or temporary variables is needed in other cases. For
    ...
    discarded by the implementation). Instead, you can write these as
    `set n/foo add mod 7 5 } 2` or `set n/foo add mod 7 5 } mod 7 5`,
    respectively.
...
[\[https://docs.vagrantup.com/\]: the Vagrant Documentation Web
site](https://docs.vagrantup.com/) or reference the book *Vagrant: Up
and Running* (Mitchell Hashimoto, 2013). When using the Vagrant
appliance, it may be advisable to disconnect the media library’s storage
medium before running vagrant destroy, because if you are running
Vagrant as a user with write permission to the folder, it may follow the
symlink and erase it. This seems to possibly be a bug in Vagrant; this
may be related to
[\[https://github.com/MSOpenTech/vagrant-azure/issues/30\]: this
issue](https://github.com/MSOpenTech/vagrant-azure/issues/30).
...
This section should have no prerequisites. It should contain a summary
of the basics of English in many languages to allow the other sections
to be understood.
...
### Related projects and inspirations {#relatedprojectsandinspirations}
...
-   KDE (<https://www.kde.org/>) communities have produced a large
    number of successful free/libre/open-source software packages, which
    are already in use to facilitate development of this project.
...
-   Free Software Foundation (<https://www.fsf.org/>) promotes
    principles of freedom as used in and by this project.
...
-   Madge, Robert. "GDPR: data portability is a false promise"
    ...
    2017 July 4, in *MyData*.: This article discusses how corporations,
...
-   "National Museum of Brazil fire"
    ...
    *Wikipedia*. This tragedy exemplifies how organizational apathy to
...
-   Browne, Malachy. "YouTube Removes Videos Showing Atrocities in
    ...
    2017 Aug. 22, in *The New York Times*. As corporate-mediated
...
-   The practice of "wiping" (<https://en.wikipedia.org/wiki/Wiping>;
    ...
    historic broadcast media (radio and television) shows is
    illustrative of popular attitudes towards historical preservation:
    when value is not recognized at a given moment, things are wantonly
    neglected or destroyed without regard for what value they may hold
    in the future. Similarly, many films are lost, especially those that
    were stored using fragile and flammable nitrocellulose film, in the
    absence of comprehensive systems in place to ensure their
    preservation (<https://en.wikipedia.org/wiki/Film_preservation>;
    <https://en.wikipedia.org/wiki/Lost_film>;
    <https://en.wikipedia.org/wiki/Nitrocellulose#Film>).
-   "Slack's bait and switch", in *Opkode*
    (<https://opkode.com/blog/slacks-bait-and-switch/>), as well as
    [\[https://news.ycombinator.com/item?id=16567009\]: this
    discussion](https://news.ycombinator.com/item?id=16567009) in
    response to it, and especially
    [\[https://news.ycombinator.com/item?id=16569232\]: this
    comment](https://news.ycombinator.com/item?id=16569232); also
    [\[https://medium.freecodecamp.org/so-yeah-we-tried-slack-and-we-deeply-regretted-it-391bcc714c81\]:
    this
    article](https://medium.freecodecamp.org/so-yeah-we-tried-slack-and-we-deeply-regretted-it-391bcc714c81),
    and [\[https://get.slack.help/hc/en-us/articles/201658943\]: this
    page](https://get.slack.help/hc/en-us/articles/201658943),
    [\[https://get.slack.help/hc/en-us/articles/115002422943-Message-and-storage-limits-on-the-Free-plan\]:
    this
    page](https://get.slack.help/hc/en-us/articles/115002422943-Message-and-storage-limits-on-the-Free-plan),
    and
    [\[https://get.slack.help/hc/en-us/articles/204897248-guide-to-slack-data-exports\]:
    this other
    page](https://get.slack.help/hc/en-us/articles/204897248-guide-to-slack-data-exports)
    from Slack themselves. The popular Slack messaging app is designed
    to capture its users' data, without allowing it to be easily
    exported: a Slack user cannot export (or even view) all the data
    they have access to. This prevents people from practically
...
-   Snapchat (<https://en.wikipedia.org/wiki/Snapchat>), like Slack, is
    a company that predicates its entire business model on the wanton
    ...
    acceptable, never mind that it is *widespread*.
